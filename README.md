...
10. Left side panel with the list of notes/folders can have its size adjusted by dragging from the edge. It should be possible to drag all the way to the left until the entire panel is hidden. It can also be hidden entirely by clicking on a button on the top of the panel. Clicking on the same button will toggle between left panel showing or hidden.
